...
The folder listings are a functionality of the [FolderPage](FolderPage.md) plugin, the tag listings of the [TagPage](TagPage.md) plugin. See the plugin pages for customization options.
