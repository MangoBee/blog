...
When [creating your own components](creating%20components.md), you can include this `popover-hint` class to also include it in the popover.

Similar to Obsidian, [images referenced using wikilinks](quartz%20layout.png) can also be viewed as popups.
